function [X,PD] = PP_ParticleFilter_bychen2_modified_global2(Y,mu0,cov0,F,R,alpha,w0,N,p,neuron,top,bot,pl,mag)
...
%     pred_x = X(t-1,:)*F;
%     sd_mean = sw*sd;
%     sr_mean = angle2real(sd_mean,angle);
% 	[sr_mean, m_t, v_t] = Adam(sr_mean, angle, m_t, v_t,t, Y(t,:), pred_x, phi1, phi2, eta, pl, alpha_t, mag, beta1_t, beta2_t, neuron);
    [sr, m_t, v_t] = Adam(sr, angle, m_t, v_t,t, Y(t,:), sx2, phi1, phi2, eta, pl, alpha_t, mag, beta1_t, beta2_t, neuron);
